This is my first project using C++, file handling and command prompt, which basically works as an advisor of a shopping mall, like providing the details of products, their prices
...
So, to see the output, execute the program.exe file.
